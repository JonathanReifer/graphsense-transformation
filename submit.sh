...
"$SPARK_HOME"/bin/spark-submit \
  ...
  --jars ~/.ivy2/local/at.ac.ait/graphsense-clustering_2.11/0.4.1/jars/graphsense-clustering_2.11.jar,/root/.ivy2/cache/commons-configuration/commons-configuration/jars/commons-configuration-1.6.jar \
